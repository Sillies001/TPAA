...
def verify() -> dict[str, object]:
    ...
    checks.append(
        ...
        if text.count(f"ref: {SOURCE_REVISION}") == 7
        else _fail(
            "checkout_exact_candidate_revision",
            f"expected 7 exact-source checkouts using {SOURCE_REVISION}",
        )
    )
    checks.append(
    ...
    required_tokens = (
        ...
        "--evidence evidence/m1-world-001/${{ matrix.platform }}/basic-episode.json",
        ...
        "--evidence evidence/m1-batch-4/${{ matrix.platform }}/platform.json",
        ...
        "python tools/dev/tpaa_dev.py m2-air-formal-delivery-compare",
        ...
        "--evidence evidence/m2-met-004/${{ matrix.platform }}/sns-detection.json",
        "python tools/dev/tpaa_dev.py m2-sns-detection-compare",
        "--windows downloaded/evidence/m2-met-004/windows/sns-detection.json",
        "--linux downloaded/evidence/m2-met-004/linux/sns-detection.json",
        "--evidence evidence/cross-platform/m2-met-004-logical-equivalence.json",
        "python tools/dev/tpaa_dev.py m2-sns-accuracy-incremental-check",
        "--evidence evidence/m2-met-005/${{ matrix.platform }}/sns-accuracy-incremental.json",
        "python tools/dev/tpaa_dev.py m2-sns-accuracy-incremental-compare",
        "--windows downloaded/evidence/m2-met-005/windows/sns-accuracy-incremental.json",
        "--linux downloaded/evidence/m2-met-005/linux/sns-accuracy-incremental.json",
        "--evidence evidence/cross-platform/m2-met-005-incremental-logical-equivalence.json",
        "python tools/dev/tpaa_dev.py m2-runtime-contract-incremental-check",
        "--evidence evidence/m2-met-006/${{ matrix.platform }}/runtime-contract-incremental.json",
        "python tools/dev/tpaa_dev.py m2-runtime-contract-incremental-compare",
        "--windows downloaded/evidence/m2-met-006/windows/runtime-contract-incremental.json",
        "--linux downloaded/evidence/m2-met-006/linux/runtime-contract-incremental.json",
        "--evidence evidence/cross-platform/m2-met-006-incremental-logical-equivalence.json",
        "python tools/dev/tpaa_dev.py m2-batch-replay-incremental-check",
        "--evidence evidence/m2-met-007/${{ matrix.platform }}/batch-replay-incremental.json",
        "python tools/dev/tpaa_dev.py m2-batch-replay-incremental-compare",
        "--windows downloaded/evidence/m2-met-007/windows/batch-replay-incremental.json",
        "--linux downloaded/evidence/m2-met-007/linux/batch-replay-incremental.json",
        "--evidence evidence/cross-platform/m2-met-007-incremental-logical-equivalence.json",
        "python tools/dev/tpaa_dev.py m2-authority-gap-sentinel-check",
        "--evidence evidence/m2-authority-gap/${{ matrix.platform }}/sentinel.json",
        "python tools/dev/tpaa_dev.py m2-authority-gap-sentinel-compare",
        "--windows downloaded/evidence/m2-authority-gap/windows/sentinel.json",
        "--linux downloaded/evidence/m2-authority-gap/linux/sentinel.json",
        "--evidence evidence/cross-platform/m2-authority-gap-sentinel.json",
        "python tools/dev/tpaa_dev.py m2-batch-2-review",
        "--platform-root downloaded/evidence",
        "--logical-root evidence/cross-platform",
        "--output evidence/m2-batch-2/review.json",
        ...
        "evidence/m1-world-001/${{ matrix.platform }}/basic-episode.json",
        ...
        "python tools/dev/tpaa_dev.py m1-batch-4-compare",
        "--windows downloaded/evidence/m1-batch-4/windows/platform.json",
        "--linux downloaded/evidence/m1-batch-4/linux/platform.json",
        ...
        "m1-exit-review:",
        "name: M1 Exit Review",
        "python tools/dev/tpaa_dev.py m1-exit-review",
        "--batch4-windows downloaded/platform/evidence/m1-batch-4/windows/platform.json",
        "--batch4-linux downloaded/platform/evidence/m1-batch-4/linux/platform.json",
        "--batch4-logical downloaded/logical/m1-batch-4-logical-equivalence.json",
        "--output evidence/m1-exit/review.json",
        f"tpaa-m1-exit-review-{SOURCE_REVISION}",
        "m0-exit-review:",
    ...
    required_gate_tokens = (
        ...
        '_dispatcher("m1-aircraft-identity-check")',
        '_dispatcher("m1-canonical-flight-channels-check")',
        '_dispatcher("m1-evaluation-context-check")',
        '_dispatcher("m1-lineage-quality-check")',
        '_dispatcher("m1-basic-episode-check")',
        '_dispatcher("m1-basic-stage-check")',
        '_dispatcher("m1-stage-quality-check")',
