#!/usr/bin/env python3
"""Cross-platform comparison for M2-MET-001 general Metric Engine evidence."""
...
EXPECTED_SCHEMA = "TPAA_M2_MET_001_GENERAL_ENGINE_EVIDENCE_V1"
EXPECTED_TASK_ID = "M2-MET-001"
EXPECTED_TRACKING_ISSUE = 97
...
def compare(
    ...
    *,
    ...
    return {
        "schema": "TPAA_M2_MET_001_CROSS_PLATFORM_EVIDENCE_V1",
