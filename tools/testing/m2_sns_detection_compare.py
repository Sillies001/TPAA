#!/usr/bin/env python3
"""Cross-platform comparison for M2-MET-004 SNS detection."""
...
def compare(windows_path: Path, linux_path: Path, *, expected_revision: str) -> dict[str, object]:
    ...
    checks = {
        ...
        "tasks_exact": windows.get("task_id") == linux.get("task_id") == "M2-MET-004",
    ...
    return {
        "schema": "TPAA_M2_MET_004_SNS_DETECTION_CROSS_PLATFORM_EVIDENCE_V1",
        "task_id": "M2-MET-004",
        "tracking_issue": 97,
