#!/usr/bin/env python3
"""Cross-platform logical comparison for M2-WORLD-002 evidence."""
...
EXPECTED_SCHEMA = "TPAA_M2_WORLD_002_RADAR_SENSOR_EVIDENCE_V1"
EXPECTED_TASK_ID = "M2-WORLD-002"
...
def compare(
    ...
    *,
    ...
    return {
        "schema": "TPAA_M2_WORLD_002_CROSS_PLATFORM_EVIDENCE_V1",
