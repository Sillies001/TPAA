#!/usr/bin/env python3
"""Cross-platform logical comparison for M2-WORLD-003 evidence."""
...
EXPECTED_SCHEMA = "TPAA_M2_WORLD_003_STAGE_WORLD_LINEAGE_EVIDENCE_V1"
EXPECTED_TASK_ID = "M2-WORLD-003"
...
def compare(
    ...
    *,
    ...
    return {
        "schema": "TPAA_M2_WORLD_003_CROSS_PLATFORM_EVIDENCE_V1",
