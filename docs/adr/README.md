...
ADR-M0-004, ADR-M0-005, ADR-M0-006, ADR-M0-008, ADR-M0-009 and ADR-M0-010 remain **OPEN / NOT YET DECIDED**. No implementation may silently turn one of those undecided topics into a de-facto standard.
